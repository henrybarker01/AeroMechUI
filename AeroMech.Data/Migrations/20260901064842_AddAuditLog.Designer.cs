...
namespace AeroMech.Data.Migrations
{
    ...
    [Migration("20260901064842_AddAuditLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AeroMech.Data.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AeroMech.Data.Models.Employee", b =>
                {
                    ...
                    b.Property<bool>("ExcludeFromTimesheets")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("AeroMech.Data.Models.Quote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("ConvertedDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("AeroMech.Data.Models.QuoteAdHockPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("QuoteAdHockParts");
                });

            modelBuilder.Entity("AeroMech.Data.Models.QuoteLabour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("QuoteLabour");
                });

            modelBuilder.Entity("AeroMech.Data.Models.QuotePart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AeroMech.Data.Models.StockReceipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("InvoiceSubTotal")
                        .HasColumnType("double precision");

                    b.Property<double>("InvoiceTotal")
                        .HasColumnType("double precision");

                    b.Property<double>("InvoiceVat")
                        .HasColumnType("double precision");
                    ...
                    b.HasIndex("SupplierCode", "InvoiceNumber");

                    b.ToTable("StockReceipts");
                });

            modelBuilder.Entity("AeroMech.Data.Models.StockReceiptLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("CostPriceUpdated")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("QtyOnHandAfter")
                        .HasColumnType("integer");

                    b.Property<int>("QtyOnHandBefore")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AeroMech.Data.Models.StockTake", b =>
                {
                    ...
                    b.Property<int>("StockTakeNumber")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AeroMech.Data.Models.StockTakeParts", b =>
                {
                    ...
                    b.Property<int>("QtyOnHandAtPost")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AeroMech.Data.Models.TimesheetEmployeeDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TimesheetEmployeeDetails");
                });
            ...
            modelBuilder.Entity("AeroMech.Data.Models.QuoteAdHockPart", b =>
                {
                    b.HasOne("AeroMech.Data.Models.Quote", "Quote")
            ...
            modelBuilder.Entity("AeroMech.Data.Models.ServiceReport", b =>
                {
                    ...
                    b.HasOne("AeroMech.Data.Models.Quote", "Quote")
                        ...
                        .HasForeignKey("AeroMech.Data.Models.ServiceReport", "QuoteId")
            ...
            modelBuilder.Entity("AeroMech.Data.Models.StockAdjustment", b =>
                {
                    ...
                    b.HasOne("AeroMech.Data.Models.StockReceipt", "StockReceipt")
                        .WithMany()
